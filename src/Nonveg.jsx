...
import { addToCart } from './store'; // ✅ Adjust if your store file is in a different folder
import './veg.css'; // ✅ Reusing Veg styles for layout consistency

function  NonVeg(){
  const dispatch = useDispatch();

  // Access non-veg products from Redux state
